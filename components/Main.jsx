...
function Main() {
  return (
    <div
      id='home'
      className='max-w-[1240px] w-full h-full mx-auto p-4 flex justify-center items-center text-center pt-[120px]'
    >
      <div>
        <p className='uppercase text-sm tracking-widest text-white-600 mb-6'>
          Achieve more with my assistance
        </p>
        <h1 className='py-4 text-white-700 '>
          Hi, I&#39;m <span className='text-[#FFD000]'> Glaizell</span>
        </h1>
        <h1 className='py-2 text-white-700 mb-4'>
          A General Virtual Assistant
        </h1>
        <p className='py-4 text-white-600 sm:max-w-[70%] m-auto mb-2'>
